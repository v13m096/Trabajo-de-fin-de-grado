 ...
 * @author maxxi
 */
public class EnunciadoPixelArt extends javax.swing.JFrame {

    
    public EnunciadoPixelArt() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelseta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/seta.JPG"))); // NOI18N
        getContentPane().add(jLabelseta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, -1, -1));
        ...
        jTextArea2.setText("Pixel Art es una técnica que consiste en crear imágenes a partir de pequeños \ncuadrados o píxeles que se rellenan de un único color. Se hizo muy popular \nen la década de los 80 debido a las limitaciones que tenían los ordenadores \npara representar imágenes, pero hoy en día sigue siendo popular entre  los \namantes de lo retro\n\n\n\n\n\n\n\n\nReproducir este tipo de imágenes es muy fácil cuando se dispone de todos los \ncolores necesarios.\nEl reto es hacerlo usando sólo los colores primarios: magenta, amarillo y cian. \nAfortunadamente, la teoría del color nos dice que el resto de colores se puede \nobtener mezclando otros diferentes según el siguiente esquema:\n\n\t\t\t\t\t\t                 ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnunciadoPixelArt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnunciadoPixelArt().setVisible(true);
            }
        });
    }
