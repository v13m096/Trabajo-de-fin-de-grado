 ...
 * @author maxxi
 */
public class EjemplosPixelArt extends javax.swing.JFrame {

    
    public EjemplosPixelArt() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea5.setText("El programa deberá leer, por la entrada estándar, el número de casos de prueba que vendrán a continuación, cada uno en una línea.\nPara cada caso, los primeros 3 números indican la cantidad de pintura disponible de cada color básico en este orden: magenta, amarillo y cian.\nCada unidad de pintura permite pintar un píxel de ese color. Ten en cuenta que al mezclar colores se gastan unidades de todos los colores \nusados. Por ejemplo, pintar un píxel de rojo requiere gastar una unidad magenta y otra amarilla.\nA continuación aparece la secuencia de píxeles que componen la imagen codificados con letras: magenta (M), amarillo (A), cian (C), rojo (R), \nnegro (N), verde (V), violeta (L) y blanco (B). Todas las imágenes tendrán al menos 1 píxel, y ninguna tendrá más de 1.000.\n\nPara cada caso de prueba el programa escribirá una línea. Si la imagen se puede completar con las pinturas disponibles, se escribirá SI y \nlas unidades restantes de pintura magenta, amarillo y cian, en ese orden. Si la imagen no se puede completar, se escribirá NO.\n\nENTRADA DE EJEMPLO\n\n3 \n1 1 1 MCA \n3 2 1 MABBCR \n1 1 1 RL \n\nSALIDA DE EJEMPLO\n\nSI 0 0 0 \nSI 1 0 0 \nNO ");
        ...
        getContentPane().add(jLabelNOMBRE_EJERCICIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 520, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjemplosPixelArt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjemplosPixelArt().setVisible(true);
            }
        });
    }
