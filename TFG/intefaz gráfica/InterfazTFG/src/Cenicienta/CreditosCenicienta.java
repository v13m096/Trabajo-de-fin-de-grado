 ...
 * @author maxxi
 */
public class CreditosCenicienta extends javax.swing.JFrame {

    
    public CreditosCenicienta() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditosCenicienta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditosCenicienta().setVisible(true);
            }
        });
    }
