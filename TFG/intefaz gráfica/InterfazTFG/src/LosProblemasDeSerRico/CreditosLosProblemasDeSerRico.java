 ...
 * @author maxxi
 */
public class CreditosLosProblemasDeSerRico extends javax.swing.JFrame {

    
    public CreditosLosProblemasDeSerRico() {
        initComponents();
    ...
    private void jButtonENVIARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonENVIARActionPerformed
        ...
        EntregaLosProblemasDeSerRico a= new EntregaLosProblemasDeSerRico();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditosLosProblemasDeSerRico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditosLosProblemasDeSerRico().setVisible(true);
            }
        });
    }
