 ...
 * @author maxxi
 */
public class EnunciadoLosProblemasDeSerRico extends javax.swing.JFrame {

    
    public EnunciadoLosProblemasDeSerRico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelNOMBRE_EJERCICIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 480, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnunciadoLosProblemasDeSerRico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnunciadoLosProblemasDeSerRico().setVisible(true);
            }
        });
    }
