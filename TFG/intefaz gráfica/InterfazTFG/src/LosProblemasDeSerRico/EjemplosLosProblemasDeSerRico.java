 ...
 * @author maxxi
 */
public class EjemplosLosProblemasDeSerRico extends javax.swing.JFrame {

    
    public EjemplosLosProblemasDeSerRico() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjemplosLosProblemasDeSerRico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjemplosLosProblemasDeSerRico().setVisible(true);
            }
        });
    }
