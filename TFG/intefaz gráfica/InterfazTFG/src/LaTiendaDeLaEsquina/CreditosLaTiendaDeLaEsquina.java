 ...
 * @author maxxi
 */
public class CreditosLaTiendaDeLaEsquina extends javax.swing.JFrame {

    
    public CreditosLaTiendaDeLaEsquina() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelTIEMPO, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, 470, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditosLaTiendaDeLaEsquina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditosLaTiendaDeLaEsquina().setVisible(true);
            }
        });
    }
