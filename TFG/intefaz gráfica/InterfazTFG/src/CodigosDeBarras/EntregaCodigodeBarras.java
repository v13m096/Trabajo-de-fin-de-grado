...
import static CodigosDeBarras.EntregaCodigodeBarras.filename;
...
public class EntregaCodigodeBarras extends javax.swing.JFrame {
    ...
    private void jButtonREALIZARENTREGAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonREALIZARENTREGAActionPerformed
        ...
        String[] prueba1= {"65839522","65839521","8414533043847","5029365779425","5129365779425","0"};
        String esperado1="SI NO SI Desconocido SI Inglaterra NO ";
        //Variables segunda prueba
        String[] prueba2={"0029365779420","3801212121210","5029365779425","5392255778854","5602548614722","7014783619840","7591578847225","8501234567892","8909874523122","0"};
        String esperado2="SI EEUU SI Bulgaria SI Inglaterra SI Irlanda SI Portugal SI Noruega SI Venezuela SI Cuba SI India ";
        //Variables tercera prueba
        String[] prueba3={"0029365779420","3801212121210","5029365779425","5392055778854","5602548614722","7014083619840","7591578847225","8501234567892","1909874523822","0"};
        String esperado3="SI EEUU SI Bulgaria SI Inglaterra NO SI Portugal NO SI Venezuela SI Cuba SI Desconocido ";
        //Variables cuarta prueba
        String[] prueba4={"0029365779420","3801212121210","5029365779425","5392055778854","5602548614722","7014083619840","7591578847225","8501234567892","1909874523822","65839522","65839521","8414533043847","5029365779425","5129365779425","0"};
        String esperado4="SI EEUU SI Bulgaria SI Inglaterra NO SI Portugal NO SI Venezuela SI Cuba SI Desconocido SI NO SI Desconocido SI Inglaterra NO ";
        //Variables quinta prueba
        String[] prueba5= {"65839522","65839521","8414533043847","5029365779425","5129365779425","0","5029365779425"};
        String esperadoW5="SI NO SI Desconocido SI Inglaterra NO  ";
        String esperadoU5="SI NO SI Desconocido SI Inglaterra NO ";
    ...
    //SEGUNDA PRUEBA
                    ...
                    jTextAreaRESULTADO.append("----PRUEBA CON TODOS LOS PAISES MENCIONADOS---"+"\n");
                    resultadoprueba=RobotWindows(filename,prueba2,esperado2,1000);
                    if(resultadoprueba.equals("Correcto")){
    //TERCERA PRUEBA
                        jTextAreaRESULTADO.append("----PRUEBA MIXTA CON NUMEROS QUE NO SON CODIGOS DE BARRAS O PAISES SIN REGISTRAR---"+"\n");
                        resultadoprueba=RobotWindows(filename,prueba3,esperado3,1000);
                        if(resultadoprueba.equals("Correcto")){
    //CUARTA PRUEBA                        
                          jTextAreaRESULTADO.append("----PRUEBA CON UNA COMBINACION MAS EXTENSA---"+"\n");
                          resultadoprueba=RobotWindows(filename,prueba4,esperado4,1000);
                           if(resultadoprueba.equals("Correcto")){
    //QUINTA PRUEBA            
                                jTextAreaRESULTADO.append("----PRUEBA DE TERMINACION EN CUANTO LEE UN 0---"+"\n");
