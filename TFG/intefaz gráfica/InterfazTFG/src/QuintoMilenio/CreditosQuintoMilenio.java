 ...
 * @author maxxi
 */
public class CreditosQuintoMilenio extends javax.swing.JFrame {

    
    public CreditosQuintoMilenio() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditosQuintoMilenio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditosQuintoMilenio().setVisible(true);
            }
        });
    }
