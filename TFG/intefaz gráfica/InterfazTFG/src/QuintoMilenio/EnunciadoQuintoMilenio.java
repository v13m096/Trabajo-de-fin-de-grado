 ...
 * @author maxxi
 */
public class EnunciadoQuintoMilenio extends javax.swing.JFrame {

    
    public EnunciadoQuintoMilenio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("Si cogemos a los actores protagonistas de una película como la emblemática Regreso al Futuro y analizamos sus fechas de cumpleaños, vemos\nTúker Chiménez ve cosas escondidas en cualquier lado. Una mancha de humedad en la pared se le antoja la cara de la anterior propietaria de \nuna casa; el sonido del viento le parece un susurro venido del más allá; una nube con forma peculiar le convence de la existencia de vida \nextraterrestre.\n\nAhora le ha dado por ver mensajes ocultos en cualquier sitio. Por poner un ejemplo, si lee el siguiente titular: \"El presidente del Gobierno \nse somete esta noche al escrutinio de varios periodistas en Televisión Española.\", se las ingenia para leer un \"te odio\" oculto que \nle mantiene en vela toda la noche:\n\nel presidenTe dEl gobierno se sOmete esta noche al escrutinio De varIos periOdistas en televisión española.\n\nAhora quiere automatizar la tarea de la búsqueda de estos mensajes.");
        jScrollPanelTEXTO.setViewportView(jTextArea2);

        getContentPane().add(jScrollPanelTEXTO, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 1000, 380));
    ...
    private void jButtonENVIARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonENVIARActionPerformed
        ...
        EntregaQuintoMilenio a= new EntregaQuintoMilenio();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnunciadoQuintoMilenio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnunciadoQuintoMilenio().setVisible(true);
            }
        });
    }
