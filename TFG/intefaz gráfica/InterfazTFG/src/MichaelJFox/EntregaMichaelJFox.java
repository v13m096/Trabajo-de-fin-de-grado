...
import static MichaelJFox.EntregaMichaelJFox.filename;
import java.io.File;
 ...
 * @author maxxi
 */
public class EntregaMichaelJFox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelNOMBRE_EJERCICIO.setText("MICHAEL J. FOX Y EL PATO DONALD");
    ...
    private void jButtonEJEMPLOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEJEMPLOSActionPerformed
        EjemplosMichaelJFox a= new EjemplosMichaelJFox();
        a.setVisible(true);
    ...
    private void jButtonCREDITOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCREDITOSActionPerformed
        // TODO add your handling code here:
         CreditosMichaelJFox a= new CreditosMichaelJFox();
        a.setVisible(true);
    ...
    private void jButtonREALIZARENTREGAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonREALIZARENTREGAActionPerformed
        ...
        String[] prueba1={"4","9/6/1961 22/10/1938 31/5/1961 20/4/1964","5","9/6/1961 22/10/1938 31/5/1961 20/4/1964 9/6/1934","0"};
        String esperado1="NO SI ";
        //Variables segunda prueba
        String[] prueba2= {"20","9/6/1961 22/10/1938 31/5/1961 20/4/1964 10/6/1961 22/11/1938 31/6/1961 20/1/1964 9/7/1934 24/5/1900 17/1/1600 17/2/1600 26/4/1967 13/2/1789 11/1/1600 2/1/1600 3/1/2000 7/1/1987 2/9/1658 29/2/1897","0"};
        String esperado2="NO ";
        //Variables tercera prueba
        String[] prueba3={"42","9/6/1961 22/10/1938 31/5/1961 20/4/1964 10/6/1961 22/11/1938 31/6/1961 20/1/1964 9/7/1934 24/5/1900 17/1/1600 17/2/1600 26/4/1967 13/2/1789 11/1/1600 2/1/1600 3/1/2000 7/1/1987 2/9/1658 2/9/1897 1/1/1600 4/1/1789 17/3/1689 20/2/1897 31/1/1789 22/5/1669 9/8/1698 10/7/1678 24/2/1999 9/12/1999 13/1/1678 3/2/1999 1/5/1992 20/12/1996 13/12/1964 15/8/1954 26/5/1698 7/12/1998 20/5/1972 7/5/1987 22/9/1994 9/12/1999","0"};
        String esperado3="SI ";
        //Variables cuarta prueba
        String[] prueba4= {"4","9/6/1961 22/10/1938 31/5/1961 20/4/1964","5","9/6/1961 22/10/1938 31/5/1961 20/4/1964 9/6/1934","0","5","9/6/1961 22/10/1938 31/5/1961 20/4/1964 9/6/1934"};
        String esperadoW4="NO SI  ";
        String esperadoU4="NO SI ";
    ...
    // PRIMERO COMPROBAMOS QUE EL ALUMNO HAYA SELECCIONADO SU CODIGO    
        if(filename!=null){
            String so=EjecutadorMichaelJFox.SistemaOperativo(filename);
    ...
    // INSTANCIAMOS UN OBJETO DE LA CLASE EJECUTADOR PARA PODER TENER ACCESO A LOS METODOS QUE NECESITAREMOS PARA LAS REALIZAR LAS PRUEBAS        
            EjecutadorMichaelJFox objeto= new EjecutadorMichaelJFox();
    ...
    //SEGUNDA PRUEBA
                    ...
                    jTextAreaRESULTADO.append("----PRUEBA CON 20 FECHAS Y NINGUNA REPETIDA---"+"\n");
                    resultadoprueba=RobotWindows(filename,prueba2,esperado2,2000);
                    if(resultadoprueba.equals("Correcto")){
    //TERCERA PRUEBA
                        jTextAreaRESULTADO.append("----PRUEBA PESADA CON MULTIPLES FECHAS CON UNA UNICA COINCIDENCIA---"+"\n");
    ...
    //CUARTA PRUEBA                        
                          ...
                          resultadoprueba=RobotWindows(filename,prueba4,esperadoW4,2000);
                          if(resultadoprueba.equals("Correcto")){
    ...
    //CUARTA PRUEBA                        
                          jTextAreaRESULTADO.append("----PRUEBA DE TERMINACION CUANDO DICTA EL PROBLEMA---"+"\n");
                          resultadoprueba=RobotUbuntu(filename,prueba4,esperadoU4,2000);
                          if(resultadoprueba.equals("Correcto")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntregaMichaelJFox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntregaMichaelJFox().setVisible(true);
            }
        });
    }
