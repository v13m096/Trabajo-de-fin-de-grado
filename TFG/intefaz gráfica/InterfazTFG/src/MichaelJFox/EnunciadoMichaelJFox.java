 ...
 * @author maxxi
 */
public class EnunciadoMichaelJFox extends javax.swing.JFrame {

    
    public EnunciadoMichaelJFox() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/DONALD.JPG"))); // NOI18N
        ...
        getContentPane().add(jLabelNOMBRE_EJERCICIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 530, 40));
        ...
        jTextArea2.setText("Si cogemos a los actores protagonistas de una película como la emblemática Regreso al Futuro y analizamos sus fechas de cumpleaños, vemos\nque ninguna de ellas coincide. Es decir, aunque durante el rodaje celebraron algún que otro cumpleaños, no hubo ningún día en el que soplaran \nlas velas dos actores.\n\nLa cosa cambia si a ese elenco añadimos, por ejemplo, los personajes clásicos de Disney. Resulta que tanto Michael J. Fox (que interpretaba \na Marty McFly) como el pato Donald celebran su cumpleaños el día 9 de junio1(Siempre y cuando consideremos como nacimiento de Donald \nla fecha de estreno del primer corto en el que apareció en 1934 titulado \"La gallinita sabia\" (en inglés \"The Wise Little Hen\"))\n\nEn realidad, no es tan raro que cuando se junta un grupo de gente haya dos personas que cumplan años el mismo día. Es lo que se conoce \ncomo la paradoja del cumpleaños. Con un sencillo cálculo se puede comprobar que si juntamos a 23 personas elegidas al azar, la probabilidad \nde que haya dos que coincidan es de más del 50%. Si subimos a 57 personas, la probabilidad se dispara hasta el 99%.\n\n\n\n");
    ...
    private void jButtonENVIARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonENVIARActionPerformed
        ...
        EntregaMichaelJFox a= new EntregaMichaelJFox();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnunciadoMichaelJFox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnunciadoMichaelJFox().setVisible(true);
            }
        });
    }
