 ...
 * @author maxxi
 */
public class CreditosMichaelJFox extends javax.swing.JFrame {

    
    public CreditosMichaelJFox() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreditosMichaelJFox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreditosMichaelJFox().setVisible(true);
            }
        });
    }
