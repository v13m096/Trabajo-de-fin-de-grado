 ...
 * @author maxxi
 */
public class EjemplosMichaelJFox extends javax.swing.JFrame {

    
    public EjemplosMichaelJFox() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea5.setText("La entrada está formada por distintos casos de prueba, cada uno en dos líneas.\n\nLa primera línea de cada caso de prueba contiene el número de personas en el grupo. La segunda contiene las fechas de nacimiento de cada \nuno de ellos, con el formato día/mes/año. Todas las fechas serán válidas y estarán comprendidas entre el año 1600 y el 2000.\n\nLa entrada termina con una línea con un 0 que no debe procesarse.\n\nPor cada caso de prueba se escribirá SI si hay algún cumpleaños repetido y NO en caso contrario.\n\nENTRADA DE EJEMPLO\n\n4 \n9/6/1961 22/10/1938 31/5/1961 20/4/1964 \n5 \n9/6/1961 22/10/1938 31/5/1961 20/4/1964 9/6/1934 \n0\n\nSALIDA DE EJEMPLO\n\nNO \nSI");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjemplosMichaelJFox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjemplosMichaelJFox().setVisible(true);
            }
        });
    }
